...
description: >
  Expert knowledge base for the EPG4001 Aprendizaje Supervisado course (Magíster en Inteligencia Artificial,
  Pontificia Universidad Católica de Chile, Prof. Jorge Luis Bazán, Segundo Bimestre 2026).
  Covers supervised learning fundamentals, linear regression, logistic regression, model selection,
  regularization (Ridge, Lasso, Elastic Net), diagnostics, k-NN, classification metrics, ROC curves,
  cross-validation and bootstrap, bias-variance, LDA/QDA, Naive Bayes, decision trees and Random Forest,
  Support Vector Machines (SVM, kernels), imbalanced classification (SMOTE, undersampling), KNN,
  and R programming for statistical learning.
  Use this skill whenever the user asks questions about their Aprendizaje Supervisado course,
  homework, labs, controls (Q1, Q2), project, or any topic from the EPG4001 syllabus.
  Also trigger when they mention concepts like regresión lineal, regresión logística, k-NN,
  clasificación, ANOVA, AIC, BIC, VIF, multicolinealidad, Ridge, Lasso, curva ROC, matriz de confusión,
  validación cruzada, K-Fold, bootstrap, sesgo-varianza, F1 score, accuracy, análisis discriminante,
  LDA, QDA, Naive Bayes, árboles de decisión, Random Forest, índice de Gini, entropía,
  SVM, máquinas de vectores de soporte, hiperplano, margen, kernel, vectores de soporte,
  clases desbalanceadas, SMOTE, oversampling, undersampling, Tomek, probabilidad de corte, KNN,
  or any dataset used in the course (Default, PimaIndiansDiabetes, Smarket, Vehicle, globwarm, Advertising).
